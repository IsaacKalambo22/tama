...
app.patch('/tama/reports-publications/:id', upload.fields([{ name: 'file', maxCount: 1 }]), (req, res, next) => {
    var _a, _b;
    console.log(req.body);
    console.log(req.files);
    try {
...
app.patch('/tama/forms/:id', upload.fields([{ name: 'file', maxCount: 1 }]), (req, res, next) => {
    var _a, _b;
    console.log(req.body);
    console.log(req.files);
    try {
