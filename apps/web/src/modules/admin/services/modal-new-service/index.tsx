...
const ModalNewService = ({ isOpen, onClose }: Props) => {
  ...
  const onSubmit = async (values: zod.infer<typeof formSchema>) => {
    ...
    const result = await createService(payload, fullPath, "/admin", "/")
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} name="Add New Service">
      <Form {...form}>
        <form
