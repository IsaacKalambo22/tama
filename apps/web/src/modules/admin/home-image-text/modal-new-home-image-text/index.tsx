...
import { createHomeImageText } from "../../actions"
...
const ModalNewHomeImageText = ({ isOpen, onClose }: Props) => {
  ...
  const onSubmit = async (values: zod.infer<typeof formSchema>) => {
    ...
    try {
      ...
      const result = await createHomeImageText(payload, fullPath, "/admin", "/")

      onClose()
      if (result.success) {
        toast.success("New home image text created successfully")
      } else {
        toast.error(result.error ?? "An error occurred.")
      }
    } catch (error) {
      console.error("Error creating home image text:", error)
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} name="Add New HomeImageText">
      <Form {...form}>
        <form
...
export default ModalNewHomeImageText
