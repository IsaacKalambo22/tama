...
const Vacancy = async () => {
  ...
  try {
    ...
    return (
      <div>
        <AddNewHeader name="Vacancy List" buttonName="New Vacancy" />
        <p className="text-red-500">Failed to load vacancies.</p>
      </div>
    )
  }
    ...
    <div>
      ...
      {vacancies?.length > 0 ? (
        ...
        <p className="text-gray-500 mt-4">
          No vacancies available. Create a new vacancy to get started!
        </p>
      )}
    </div>
  )
