...
import FormsActionDropdown from "../../forms-documents/forms-action-dropdown"

type Props = {
  file: FileProps
}
const ReportsAndPublicationsCard = ({ file }: Props) => {
  return (
    <Link
...
export default ReportsAndPublicationsCard
