      ...
      <Card className="p-8 rounded-2xl shadow-none">
        <AccordionItem value="item-1">
          ...
          <AccordionContent className="text-gray-700 mt-4 text-sm leading-relaxed">
            ...
            tobacco growers.
            <br />
            To become a member, a grower (whether small-scale, medium, or
            corporate) must register with the Tobacco Commission (TC) for the
            following year&apos;s production.
            <br />
            The TC registration form asks for the grower&apos;s association,
            where TAMA should be written. This officially registers the grower
            as a member, entitling them to TAMA&apos;s services, including
            advocacy and tobacco sales representation.
            <br />
            Membership extends to the club and its registered members or estate
            (including managers).
            <br />
        ...
        <AccordionItem value="item-2">
          ...
          <AccordionContent className="text-gray-700 mt-4 text-sm leading-relaxed">
            ...
            <div className="mt-3 grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-start gap-3">
                <span className="text-green-500 text-[1rem]">✔</span>
                <p>False Labour Prevention & Protection</p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-green-500 text-[1rem]">✔</span>
        ...
        <AccordionItem value="item-3">
          ...
          <AccordionContent className="text-gray-700 mt-4 text-sm leading-relaxed">
            Tobacco production is not easy, and some unscrupulous individuals
            and groups aim to exploit farmers.
            <br />
            TAMA steps in to ensure farmers receive fair compensation through a
            win-win protocol, protecting their livelihoods and securing
            equitable market opportunities.
          </AccordionContent>
        </AccordionItem>
