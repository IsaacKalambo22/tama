          ...
          <AccordionContent className="text-gray-700 mt-4 text-sm leading-relaxed">
            <div className="grid grid-cols-1 gap-3">
              <div className="flex items-start gap-3">
                ...
                <p>
                  TAMA Farmers Trust membership is voluntary and renews annually
                  for tobacco growers
                </p>
              </div>
              <div className="flex items-start gap-3">
                <span className="text-green-500 text-[1rem]">✔</span>
                <p>
                  Growers (small-scale, medium, or corporate) must register with
                  the Tobacco Commission (TC) for the following year's
                  production
                </p>
              </div>
              <div className="flex items-start gap-3">
          ...
          <AccordionContent className="text-gray-700 mt-4 text-sm leading-relaxed">
            <div className="grid grid-cols-1 gap-3">
              <div className="flex items-start gap-3">
                <span className="text-green-500 text-[1rem]">✔</span>
                <p>
                  Protects farmers from unscrupulous individuals and groups who
                  aim to exploit them
                </p>
              </div>
              <div className="flex items-start gap-3">
          ...
          <AccordionContent className="text-gray-700 mt-4 text-sm leading-relaxed">
            <div className="grid grid-cols-1 gap-3">
              ...
              <div className="flex items-start gap-3">
                <span className="text-green-500 text-[1rem]">✔</span>
                <p>
                  Members benefit from the association's services on both local
