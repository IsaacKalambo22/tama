...
router.post("/", verifyAdminAndManager, createReportAndPublication)
router.get("/", getAllReportsAndPublications)
router.patch("/:id", verifyAdminAndManager, updateReportAndPublication)
router.delete("/:id", verifyAdminAndManager, deleteReportAndPublication)
