...
export const createNews = async (
  ...
  try {
    ...
    void emitSystemNotification("news.created", { title: newNews.title })
...
export const updateNews = async (
  ...
  try {
    ...
    const updatedData: any = {
      title: title?.trim() === "" ? existingNews.title : title,
      imageUrl: imageUrl?.trim() === "" ? existingNews.imageUrl : imageUrl,
      content: content?.trim() === "" ? existingNews.content : content,
      author: author?.trim() === "" ? existingNews.author : author,
    }
